...
namespace BusinessEntities.Factories
{
    public class QuestionAttemptFactory
    {
        ...
        {
            var questionAttempt = GetQuestionAttemptFromQuestionType(quizQuestion.Question.QuestionType);
            ...
            (QuestionType type)
        {
            return type switch
            {
                ...
                _ => throw new InvalidCastException("No valid question type was provided")
            };
        }
    }
}