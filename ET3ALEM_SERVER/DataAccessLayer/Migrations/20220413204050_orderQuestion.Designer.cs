...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220413204050_orderQuestion")]
    partial class orderQuestion
    {
            ...
            modelBuilder.Entity("BusinessEntities.Models.OrderedElement", b =>
                {
                    ...
                    b.Property<int?>("OrderQuestionId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessEntities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "acbd91ff-d9b9-4ef8-9261-bd6b88008d79",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAEAACcQAAAAEAs164NGG0l1/UBjEsmNcX3EoC68Ls+KtDPC5nWhY+S4r2z0dcL/uhs0YRUT5+AuEg==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "982f63aa-d1ee-436b-97aa-0e7f28d12d08",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "53165bb6-a5f6-4799-924e-527cafa1e8a1",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("BusinessEntities.Models.OrderedElement", b =>
                {
                    ...
                    b.HasOne("BusinessEntities.Models.OrderQuestion", "OrderQuestion")
                        .WithMany()
                        .HasForeignKey("OrderQuestionId1");
